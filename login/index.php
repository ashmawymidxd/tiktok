      ...
      <div class="form-container">
        ...
        <div class="form-inner">
          ...
          <form action="#" class="signup" id="form">
            ...
            <div class="field">
              <input class="input new-in" type="email" placeholder="Email" name="email" >
            </div>

            <div class="field">
              <input class="input new-in" type="password" placeholder="password" name="password" >
            </div>
            ...
            <div class="field btn">
              ...
              <div class="links">
              <a class ="link new" href="/tik/signup">signup</a> 
              <strong>or</strong>
